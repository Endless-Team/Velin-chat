...
<template>
  <div
    class="flex h-screen w-screen overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950"
  >
    <!-- Sidebar Sinistra -->
    <aside
      class="flex flex-col border-r border-white/5 bg-slate-900/80 backdrop-blur-xl w-80 min-w-70 max-w-md shadow-2xl"
    >
      <!-- User Header più compatto -->
      <div
        class="flex items-center justify-between border-b border-white/5 p-3 bg-gradient-to-r from-indigo-600/10 to-purple-600/10"
      >
        <button
          @click="openProfileModal"
          class="flex items-center gap-2 min-w-0 hover:bg-white/10 rounded-lg p-1.5 -ml-1.5 transition-all duration-200 group"
        >
          <!-- Avatar con misure più piccole: h-9 w-9 -->
          <span
            class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 font-bold text-white text-sm shadow-lg ring-2 ring-white/10"
          >
      ...
      >
        <div v-if="filteredChats.length === 0" class="p-6 text-center">
          <svg
            class="h-12 w-12 mx-auto text-slate-600 mb-3"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
    ...
    <main class="flex flex-1 flex-col min-w-0">
      ...
      >
        <div class="relative">
          ...
          ></div>
          <span
            class="relative flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500/20 to-purple-500/20 border border-white/10 shadow-2xl"
          >
            <svg
        ...
        <div
          class="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20 px-3 py-2 text-xs font-semibold text-green-300 shadow-lg"
        >
          <svg
            class="h-3 w-3"
            fill="none"
